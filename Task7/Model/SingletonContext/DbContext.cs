...
namespace Model.SingletonContext
{
    ...
    public class DbContext
    {
        ...
        /// <summary>
        /// The specialty data layer
        /// </summary>
        private ISqlServerDataLayer<Specialty> _specialtyDataLayer;
        ...
        /// <summary>
        /// Gets the specialty data layer.
        /// </summary>
        /// <returns>ISqlServerDataLayer&lt;Subject&gt;.</returns>
        public ISqlServerDataLayer<Specialty> GetSpecialtyDataLayer()
        {
            return CreateInstance(ref _specialtyDataLayer);
        }
        ...
        private ISqlServerDataLayer<T> CreateInstance<T>(ref ISqlServerDataLayer<T> dataLayer) where T:class,IEntityBase
        {
            if (dataLayer == null)
            {
