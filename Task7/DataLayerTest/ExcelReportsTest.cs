...
namespace DataLayerTest
{
    ...
    public class ExcelReportsTest
    {
        ...
        /// <summary>
        /// Defines the test method StatisticsOnExaminerReportTest.
        /// </summary>
        /// <param name="path">The path.</param>
        [TestMethod]
        [DataRow("StatisticsOnExaminerReport.xlsx")]
        public void StatisticsOnExaminerReportTest(string path)
        {
            ExcelRecordsMaker excelRecordsMaker = new ExcelRecordsMaker(_dbContext,_excelContext);

            var comparerForSorting = Comparer<StatisticOnExaminer>.Create((x,y)=>x.MiddleMark.CompareTo(y.MiddleMark));

            excelRecordsMaker.FormStatisticOnExaminerReport(comparerForSorting, path);
        ...
        /// <param name="path">The path.</param>
        [TestMethod]
        [DataRow("StatisticsOnSpecialtyReport.xlsx")]
        public void StatisticsOnSpecialityReportTest(string path)
        {
            ExcelRecordsMaker excelRecordsMaker = new ExcelRecordsMaker(_dbContext,_excelContext);

            var comparerForSorting = Comparer<StatisticOnSpecialty>.Create((x,y)=>x.MiddleMark.CompareTo(y.MiddleMark));

            excelRecordsMaker.FormStatisticOnSpecialityReport(comparerForSorting, path);

            File.Exists(path);
        }

        /// <summary>
        /// Defines the test method StatisticsByYearReportTest.
        /// </summary>
        /// <param name="path">The path.</param>
        [TestMethod]
        [DataRow("StatisticsByYearReport.xlsx")]
        public void StatisticsByYearReportTest(string path)
        {
            ExcelRecordsMaker excelRecordsMaker = new ExcelRecordsMaker(_dbContext,_excelContext);

            var comparerForSorting = Comparer<StatisticByYear>.Create((x,y)=>x.MiddleMark.CompareTo(y.MiddleMark));

            excelRecordsMaker.FormStatisticByYearReport(comparerForSorting, path);
